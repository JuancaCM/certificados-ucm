                    ...
                    <div class="card-body">
                        <div class="form-label mb-3">
                            ...
                            <input name="dimension" type="text" class="form-control" aria-label="course_names"
                                aria-describedby="basic-addon1" value="{{ $dimension->name }}" required>
                        </div>
                        <div class="form-floating mb-3">
                            ...
                            <textarea name="description" class="form-control" style="height: 100px">{{ $dimension->description }}</textarea>
                        </div>
