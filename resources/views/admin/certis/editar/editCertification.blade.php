                            ...
                            <div class="col s12 m6">
                                ...
                                <div class="form-label mb-3">
                                    <input name="schedule" type="text" class="form-control" aria-label="schedule"
                                        aria-describedby="basic-addon1" value="{{ $course->schedule }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12 m6">
                                <div class="form-label mb-3">
                                    ...
                                    <input name="sessions" type="number" min="0" class="form-control"
                                        aria-label="sessions" aria-describedby="basic-addon1"
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                ...
                                <input name="synchronous_hours" type="number" min="0" class="form-control"
                                    aria-label="synchronous_hours" aria-describedby="basic-addon1"
                            ...
                            <div class="col s12 m6">
                                <div class="form-label mb-3">
                                    ...
                                    <input name="autonomous_hours" type="number" min="0" class="form-control"
                                        aria-label="autonomous_hours" aria-describedby="basic-addon1"
                            ...
                            <div class="col s12 m6">
                                <div class="form-label">
                                    ...
                                    <input type="date" name="fecha_inicio" class="form-control"
                                        value="{{ $course->start }}" required>
                                </div>
                            </div>
                            <div class="col s12 m6">
                                <div class="form-label mb-3">
                                    <label><span style="color: red">*</span>Fecha de termino:</label>
                                    <input type="date" name="fecha_termino" class="form-control" value="{{ $course->end }}" required>
                                </div>
                            </div>
                        </div>
                        <input hidden name="userId" type="text" class="form-control" placeholder="Telefono"
                            value="{{ $course->id }}" aria-label="Telefono" aria-describedby="basic-addon1">
